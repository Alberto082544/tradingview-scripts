"""
Optimización GBPUSD MA Cross con 4 parámetros + Walk-Forward + spread realista.
...
def main():
    print("=" * 80)
    print("  GBPUSD MA Cross — Optimización 4 params (EMA × SMA × SL × RR)")
    print(f"  IS 2018-2022 + OOS 2023-2024 | Spread {SPREAD_PIPS} pips realista")
    print("=" * 80)

    df_is = load("GBPUSD_M15_histdata.csv", "2018-01-01", "2022-12-31")
    df_oos = load("GBPUSD_M15_histdata.csv", "2023-01-01", "2024-12-31")
    ...
    df.to_csv(out_dir / "optim_gbpusd_4params_WF.csv", index=False)
    print(f"\n  Guardado: {out_dir/'optim_gbpusd_4params_WF.csv'}")
