...
DEFAULT_PARAMS = {
    ...
    'ATR_Period':    14,
    'SL_ATR_Mult':  1.5,
    'RR':           2.0,    # 0 = sin TP fijo
    'BE_Trigger':   1.0,    # activar BE a X*ATR de ganancia
    'BE_Offset':    0.0002, # offset BE en precio
    'Trail_Start':  1.5,    # iniciar trailing a X*ATR
    'Trail_Dist':   1.0,    # distancia trailing en X*ATR
    'MaxSpreadPips':  3.0,
    'LotRiskPct':    0.5,
    'MaxLots':       4.0,
}
