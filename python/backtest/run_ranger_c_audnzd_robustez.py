"""
Ranger C AUDNZD — Analisis de Robustez Year-by-Year
Usa el mejor combo del la optimizacion IS/OOS.
Uso: python -m backtest.run_ranger_c_audnzd_robustez
"""
import os, sys
...
def main():
    print("=" * 62)
    print("  Ranger C AUDNZD — Robustez Year-by-Year")
    print("  ADX<30 RSI_L<50 RSI_S>50 MinSL=20 Trail=8 Exit=32")
    print("=" * 62)
