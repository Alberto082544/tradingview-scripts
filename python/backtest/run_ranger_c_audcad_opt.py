...
GRID = {
    ...
    'RSI_Confirm':     [0, 1],
    'StochMode':       [0, 1, 2],
    'Stoch_Long_Max':  [20, 25],
    'Stoch_Short_Min': [75, 80],
    'BB_Mid_TP':       [0, 1],
    'MinSLPips':       [12, 20],
    'TrailDistPips':   [8, 12],
    'ExitBars':        [16, 24, 32],
...
def main():
    ...
    cols  = ['ADX_H4_Max','RSI_Long_Max','RSI_Short_Min','RSI_Confirm',
             'StochMode','Stoch_Long_Max','Stoch_Short_Min',
             'BB_Mid_TP','MinSLPips','TrailDistPips','ExitBars',
             'is_n','is_pf','oos_pf','is_ann','is_dd','oos_dd','time_pct','wf_ratio','score']
